"""
NIRIKSHAN - Vercel Serverless Function API Entrypoint
Exports handler for /api/* routes on Vercel Serverless Python Runtime
"""
...
# Add parent directory to sys.path so it imports db.py
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/api/health":
            ...
            self.send_json({"error": "API route not found", "path": path}, 404)
    ...
    def do_POST(self):
        ...
        if path == "/api/tests":
            ...
            self.send_json({"error": "API endpoint not found", "path": path}, 404)
    ...
    def handle_stats(self):
        ...
        total_today = 1284 + max(0, local_tests_count - 5)
